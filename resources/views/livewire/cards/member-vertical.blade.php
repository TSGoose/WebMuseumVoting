<article class="flex flex-col rounded-lg shadow-sm max-w-[370px]">
  ...
  <div  class="flex justify-between items-center w-full aspect-[1.85] rounded-t-lg bg-cover bg-center bg-[url('https://cdn.builder.io/api/v1/image/assets/TEMP/50c8f2882bca7fabe913eaa22930fec71368321080635b3c15be6ea6c588c493?apiKey=6af3166b190849ae913a27151a2b7816&')]" alt="Утро в сосновом лесу painting">
    ...
    <button type="button" wire:click="left" class = "flex justify-center items-center h-full w-2/12 bg-gray-900 bg-opacity-0 hover:bg-opacity-40 px-5 rounded-tl-lg"><livewire:buttons.arrow/></button> 
    <button type="button" wire:click="right" class = "flex justify-center items-center h-full w-2/12 bg-gray-900 bg-opacity-0 hover:bg-opacity-40 px-5 rounded-tl-lg scale-x-[-1]"><livewire:buttons.arrow/></button> 
  </div>
