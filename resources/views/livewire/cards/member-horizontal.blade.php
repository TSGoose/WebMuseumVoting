        ...
        <section class="flex flex-col h-full lg:flex-row items-center w-full gap-5">
          ...
          <div class="flex flex-col h-full w-full lg:w-6/12">
            ...
            <div class="flex flex-col h-1/2 grow justify-end">
              @if (!$selected)
                <button wire:click="clickSelect" class="justify-center px-7 py-3 text-base font-medium leading-6 text-center text-gray-500 whitespace-nowrap border border-solid border-zinc-200 rounded-[50px] hover:text-blue-600 hover:bg-white hover:outline hover:outline-blue-600">
                    Проголосовать
                  </button>
                @else
                  <button wire:click="clickSelect" class="justify-center px-7 py-3 text-base font-medium leading-6 text-center text-white bg-blue-600 border border-solid border-zinc-200 rounded-[50px] hover:text-blue-600 hover:bg-white hover:outline hover:outline-blue-600">
                    Отменить голос
                  </button>
                @endif
